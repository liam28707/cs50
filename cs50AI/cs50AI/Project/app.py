...
from helpers import apology, login_required, lookup, usd, generate_stock_graph
...
def quote():
    ...
    if request.method == "POST":
        ...
        img_buffer = generate_stock_graph(symbols, symbol)

        # Generate the graph URL
        graph_url = "/graphs/image.png"

        return render_template("quoted.html", symbol=symbol, graph_url=graph_url, usd=usd)
